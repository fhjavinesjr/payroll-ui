...
const menuItems = [
  ...
  {
    id: 5,
    icon: "/icons/payroll-computation.svg",
  ...
  {
    id: 6,
    icon: "/icons/payroll-register.svg",
  ...
  {
    id: 8,
    icon: "/icons/report-earnings.svg",
  ...
  {
    id: 9,
    icon: "/icons/report-deductions.svg",
  ...
  {
    id: 10,
    icon: "/icons/report-remittances.svg",
